...
export default function WorkingWithArraysAsynchronously() {
  ...
  const editTodo = (todo: any) => {
    ...
    setTodos(updatedTodos); //editing variable sets to false when user presses enter so you cant edit anymore
  };
  ...
  //new version; using correct syntax POST
